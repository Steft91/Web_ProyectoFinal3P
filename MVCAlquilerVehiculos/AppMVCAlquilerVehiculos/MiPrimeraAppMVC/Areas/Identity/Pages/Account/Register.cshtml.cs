...
namespace MiPrimeraAppMVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private UsuarioCLS CreateUser()
        {
            try
            {
                var user = Activator.CreateInstance<UsuarioCLS>();
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(UsuarioCLS)}'. " +
                    $"Ensure that '{nameof(UsuarioCLS)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<UsuarioCLS> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<UsuarioCLS>)_userStore;
        }
    }
}
